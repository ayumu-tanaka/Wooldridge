...
\NormalTok{model\_meap }\OtherTok{\textless{}{-}} \FunctionTok{lm}\NormalTok{(math10 }\SpecialCharTok{\textasciitilde{}} \FunctionTok{log}\NormalTok{(expend) }\SpecialCharTok{+}\NormalTok{ lnchprg, }\AttributeTok{data =}\NormalTok{ meap93)}
\end{Highlighting}
\end{Shaded}
\end{frame}
